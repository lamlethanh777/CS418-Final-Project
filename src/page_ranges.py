...
# region 001
mapping["Sach-Nom-Cong-Giao-1995-001"] = {"page_pairs": [(4, (433))]}

for i in range(8, 102):
    mapping["Sach-Nom-Cong-Giao-1995-001"]["page_pairs"].append((i, (432 + 8 - i)))

for i in range(104, 221):
    mapping["Sach-Nom-Cong-Giao-1995-001"]["page_pairs"].append((i, (338 + 104 - i)))
...
# region 004 done, có nguy cơ overlap
mapping["Sach-Nom-Cong-Giao-1995-004"] = {"page_pairs": [(4, (189))]}
...
mapping["Sach-Nom-Cong-Giao-1995-004"]["page_pairs"].append((63, (147, 146)))

for i in range(64, 80):
    mapping["Sach-Nom-Cong-Giao-1995-004"]["page_pairs"].append((i, (145 + 64 - i)))
# somehow skip page_128 -> actually 2 pages
mapping["Sach-Nom-Cong-Giao-1995-004"]["page_pairs"].append((80, (129, 128)))
...
mapping["Sach-Nom-Cong-Giao-1995-004"]["page_pairs"].append((98, (108, 109)))
...
mapping["Sach-Nom-Cong-Giao-1995-005"]["page_pairs"].extend(
    [(i, 5(05 + 174 - i)) for i in range(174, 183)]
)
...
# region 012 done
mapping["Sach-Nom-Cong-Giao-1995-012"] = {"page_pairs": []}

mapping["Sach-Nom-Cong-Giao-1995-012"]["page_pairs"].extend(
    [(i, (106 + 15 - i)) for i in range(15, 18)]
)
...
# region 049 done
mapping["Sach-Nom-Cong-Giao-1995-049"] = {"page_pairs": []}
