...
if __name__ == "__main__":
    ...
    input_nom_folder = "../OCR_NOM/Sach-Nom-Cong-Giao-1995-004_Processed"
    input_qngu_folder = "../OCR_QN/Sach-Nom-Cong-Giao-1995-004_Processed_Gemini"
    book_name = "Prj_55g_Tho_APCS2_Sách Nôm công giáo 1995 - 004 - Hoi Dong Tu Giao"
